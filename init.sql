...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cov` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
/*Table structure for table `cov_covtask` */

DROP TABLE IF EXISTS `cov_covtask`;
...
CREATE TABLE `cov_covtask` (
  ...
  `compareBranch` varchar(100) DEFAULT NULL,
  `status` varchar(30) DEFAULT NULL,
  `deleted` int(11) DEFAULT NULL,
  `startTime` datetime(6) DEFAULT NULL,
  `endTime` datetime(6) DEFAULT NULL,
  `lastCollectTime` datetime(6) DEFAULT NULL,
...
DROP TABLE IF EXISTS `cov_covtaskhistory`;

CREATE TABLE `cov_covtaskhistory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `runId` varchar(50) DEFAULT NULL,
  `covTaskId` varchar(30) DEFAULT NULL,
  `clientServerHostPort` varchar(30) DEFAULT NULL,
  `covFileName` varchar(50) DEFAULT NULL,
  `status` varchar(30) DEFAULT NULL,
  `createTime` datetime(6) NOT NULL,
...
DROP TABLE IF EXISTS `cov_project`;
...
/*Table structure for table `cov_reports` */

DROP TABLE IF EXISTS `cov_reports`;

CREATE TABLE `cov_reports` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `runId` varchar(50) DEFAULT NULL,
  `covTaskId` varchar(30) DEFAULT NULL,
